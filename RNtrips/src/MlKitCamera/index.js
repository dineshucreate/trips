...
class MlkitCamera extends React.PureComponent {
    ...
    render() {
        ...
        const { isFlash, flashMode, cameraType, value, isImageFullScreen, canDetectFaces, isTextRecognise, isBarcode, faces, focusedScreen } = this.state;
...
export default withNavigationFocus(MlkitCamera)